...
__all__ = [
    ...
    'SpeechDisplayAttributes', 'SREAudioLevel', 'SPPS_Verb',
    'SRTExtendableParse', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SPRsItem', 'DISPID_SVPause', 'SWTAdded',
    'SPEI_SR_PRIVATE', 'eLEXTYPE_PRIVATE15',
    'DISPID_SpeechLexiconWord', 'DISPID_SRGReset',
    'ISpObjectTokenCategory', 'DISPID_SOTs_NewEnum',
    'DISPID_SDKSetLongValue', 'ISpNotifySink',
    'DISPID_SPPNumberOfElements', 'DISPID_SVSInputSentenceLength',
    'SpeechGrammarRuleStateTransitionType', 'SAFT44kHz8BitStereo',
    'SECFNoSpecialChars', 'STCRemoteServer', 'ISpProperties',
    'SpeechVoiceCategoryTTSRate', 'STSF_FlagCreate',
    'SRSInactiveWithPurge', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPRST_NUM_STATES',
    'SPPARTOFSPEECH', 'SAFT12kHz16BitStereo',
    'SAFTCCITT_uLaw_8kHzMono', 'STCAll', 'eLEXTYPE_LETTERTOSOUND',
    'SVP_17', 'DISPID_SPEAudioStreamOffset', 'SP_VISEME_13',
    'DISPID_SRSAudioStatus', 'DISPID_SDKSetBinaryValue',
    'ISpeechLexiconPronunciation', 'SGPronounciation',
    'DISPID_SOTDataKey', 'SPWORDTYPE', 'SSTTTextBuffer',
    'SpResourceManager', 'DISPID_SPRulesCount',
    'SAFT24kHz16BitStereo', 'SVP_8', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SGRsAdd', 'DISPID_SOTMatchesAttributes',
    'SAFT11kHz16BitMono', 'SPEI_MIN_SR', 'SPWF_INPUT',
    'DISPID_SRCEPropertyNumberChange', 'ISpXMLRecoResult',
    'DISPID_SLAddPronunciation', 'DISPID_SASFreeBufferSpace',
    'DISPID_SPRs_NewEnum', 'DISPID_SPIStartTime', 'SPWT_LEXICAL',
    'DISPID_SOTCGetDataKey', 'DISPID_SRRTimes',
    'SDA_No_Trailing_Space', 'SPPS_Modifier', 'SP_VISEME_10',
    ...
    'SpeechRecognizerState', 'DISPID_SpeechRecoResult2',
    'ISpRecoCategory', 'Speech_Default_Weight', 'SDTRule',
    'SECHighConfidence', 'DISPIDSPTSI', 'IInternetSecurityMgrSite',
    'SpTextSelectionInformation', 'SpInProcRecoContext',
    'DISPID_SRCEPhraseStart', 'DISPID_SPILanguageId',
    'DISPID_SGRSTText', 'SAFT48kHz8BitMono',
    'DISPID_SVGetAudioInputs', 'DISPID_SRRRecoContext',
    'DISPID_SpeechRecognizer', 'DISPID_SpeechVoiceStatus', 'ISpAudio',
    'SpeechTokenKeyUI', 'SPSHORTCUTTYPE', 'SpeechVoiceSpeakFlags',
    'DISPID_SRGCommit', 'SP_VISEME_7', 'DISPID_SpeechPhraseInfo',
    'DISPID_SRRSaveToMemory', 'SRSEIsSpeaking', 'ISpeechVoice',
    'SPCATEGORYTYPE', 'DISPID_SPPId', 'ISpeechLexiconPronunciations',
    'SRSEDone', 'DISPID_SPIRule', 'SpeechFormatType',
    'DISPID_SVVolume', 'DISPID_SVSLastStreamNumberQueued', 'SVP_4',
    'ISpeechObjectToken', 'SPBO_PAUSE', 'DISPID_SRGetPropertyNumber',
    'SECNormalConfidence', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SLPPhoneIds', 'SPFM_OPEN_READONLY', 'ISpPhoneConverter',
    'SpeechTokenShellFolder', 'DISPID_SVRate', 'SpeechStreamFileMode',
    'DISPID_SPCLangId', 'SGLexical', 'ISpeechFileStream',
    'SpeechInterference', 'SPPS_SuppressWord', 'SPAS_STOP',
    'ISpeechRecoResultTimes', 'eLEXTYPE_PRIVATE6',
    'SpStreamFormatConverter', 'SGDSActiveWithAutoPause',
    'ISpShortcut', 'SPCS_ENABLED', 'eLEXTYPE_PRIVATE9',
    'SpPhraseInfoBuilder', 'DISPID_SPRDisplayAttributes',
    'DISPID_SREmulateRecognition', 'DISPID_SRCEventInterests',
    'DISPID_SVWaitUntilDone', 'SpeechPropertyComplexResponseSpeed',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SRSetPropertyString',
    'SVP_20', 'DISPID_SPIGetDisplayAttributes', 'SRAImport',
    'SPSSuppressWord', 'SRTAutopause', 'SGLexicalNoSpecialChars',
    'SAFT11kHz8BitMono', 'SAFTGSM610_22kHzMono', 'SpeechMicTraining',
    'SGDSActiveUserDelimited', 'ISpeechCustomStream', 'SREBookmark',
    'DISPID_SPEDisplayText', 'SVSFlagsAsync', 'DISPID_SASState',
    'DISPID_SpeechFileStream', 'DISPID_SOTCDefault',
    'ISpeechGrammarRules', 'ISpNotifySource',
    'SPEI_PROPERTY_NUM_CHANGE', 'ISpRecoGrammar2', 'SGRSTTEpsilon',
    'DISPID_SpeechPhoneConverter',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SRGIsPronounceable',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SVEventInterests', 'SVP_7', 'SVF_Stressed',
    'DISPID_SRCEAdaptation', 'SpeechRecoEvents', 'SPEI_REQUEST_UI',
    'DISPID_SGRsItem', 'SASPause', 'DISPID_SABIMinNotification',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SRCERecognizerStateChange', 'SREPhraseStart',
    'SpeechCategoryAppLexicons', 'SAFT11kHz16BitStereo',
    'SRTStandard', 'SAFT16kHz8BitStereo', 'SPFM_CREATE_ALWAYS',
    'DISPID_SpeechGrammarRuleStateTransition',
    'SpeechPropertyHighConfidenceThreshold',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SINone',
    'DISPID_SPEActualConfidence', 'SPEI_SR_BOOKMARK',
    'DISPID_SCSBaseStream', 'STSF_AppData', 'SAFT22kHz16BitMono',
    'DISPID_SpeechRecognizerStatus', 'LONG_PTR',
    'DISPID_SRCEBookmark', 'SPADAPTATIONRELEVANCE',
    'SAFT32kHz16BitStereo', 'SVP_11', 'SPPS_NotOverriden',
    'ISpeechResourceLoader', 'eLEXTYPE_RESERVED7', 'eWORDTYPE_ADDED',
    'ISpeechRecognizer', 'DISPID_SpeechObjectToken',
    'DISPID_SVEStreamEnd', 'DISPID_SRProfile', 'tagSPPROPERTYINFO',
    'DISPID_SPRFirstElement', 'DISPID_SpeechPhraseRules',
    'ISpeechTextSelectionInformation', 'SPPHRASE', 'SRTEmulated',
    'SVEAudioLevel', 'SSFMOpenReadWrite', 'DISPID_SRRAlternates',
    'ISpPhoneticAlphabetConverter', 'SpeechEmulationCompareFlags',
    'SPGRAMMARSTATE', 'DISPID_SRState', 'DISPID_SPAsItem',
    'SpInprocRecognizer', 'DISPID_SPIEngineId',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SLGetPronunciations',
    'DISPID_SOTRemove', 'SPCT_SUB_DICTATION', 'SAFT22kHz16BitStereo',
    ...
    'eLEXTYPE_VENDORLEXICON', 'SITooQuiet', 'SAFTADPCM_22kHzMono',
    'SpeechAudioFormatGUIDText', 'ISpObjectWithToken',
    'SVEStartInputStream', 'DISPID_SMSSetData', 'SVPNormal',
    'SRATopLevel', 'ISpeechObjectTokenCategory',
    'DISPID_SRCERecognition', 'DISPID_SOTCreateInstance',
    'DISPID_SPRsCount', 'SPAO_RETAIN_AUDIO', 'DISPID_SPPChildren',
    'DISPID_SASCurrentSeekPosition', 'SPWORDPRONUNCIATION',
    'SPSUnknown', 'DISPID_SOTDisplayUI', 'SECFIgnoreCase',
    'DISPID_SGRs_NewEnum', 'tagSTATSTG', 'DISPID_SPAs_NewEnum',
    'eLEXTYPE_PRIVATE12', 'SSSPTRelativeToCurrentPosition',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SpeechWaveFormatEx',
    'SP_VISEME_21', 'DISPID_SpeechGrammarRule', 'DISPID_SDKCreateKey',
    'SSTTDictation', 'SVSFPurgeBeforeSpeak', 'DISPID_SGRSTNextState',
    'SpeechAddRemoveWord', 'DISPID_SVGetAudioOutputs',
    'SDKLLocalMachine', 'SPRST_INACTIVE', 'DISPID_SPEsItem',
    'DISPID_SLWWord', 'SGRSTTWord', 'DISPID_SDKSetStringValue',
    'DISPID_SVResume', 'DISPID_SpeechPhraseReplacements',
    'SpeechAudioVolume', 'DISPID_SBSRead', 'ISpeechLexiconWords',
    'SSSPTRelativeToEnd', 'SPEI_MAX_SR', 'SpeechAudioFormatType',
    'SITooLoud', 'SPEI_VISEME', 'SPSHT_EMAIL',
    ...
    'DISPID_SOTId', 'ISpRecoResult', 'SPAUDIOOPTIONS',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SSFMCreate',
    'SRAExport', 'DISPID_SFSOpen', 'eLEXTYPE_PRIVATE1',
    'SpSharedRecoContext', 'SWTDeleted', 'SpeechTokenIdUserLexicon',
    'SREStreamEnd', 'eLEXTYPE_APP', 'SDKLDefaultLocation',
    'SAFTADPCM_22kHzStereo', 'SPINTERFERENCE_TOOLOUD',
    'SECFIgnoreKanaType', 'DISPID_SVSpeak', 'SPBO_AHEAD',
    'SVSFVoiceMask', 'DISPID_SLPPartOfSpeech', 'SPCT_COMMAND',
    'SPVPRI_OVER', 'DISPID_SVEVoiceChange', 'DISPID_SBSFormat',
    'DISPID_SPPsItem', 'SPFILEMODE', 'SAFTCCITT_uLaw_8kHzStereo',
    'ISpeechGrammarRule', 'DISPID_SRRTStreamTime',
    'SAFT24kHz8BitMono', 'Speech_StreamPos_Asap',
    'DISPID_SVSInputWordLength', 'SPRS_INACTIVE',
    'DISPID_SPRuleChildren', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SpeechMMSysAudio', 'DISPID_SPPs_NewEnum',
    'SAFT8kHz16BitStereo', 'ISpRecoGrammar', 'SREStreamStart',
    'DISPID_SPEDisplayAttributes', 'SITooSlow',
    'SpeechRegistryUserRoot', 'SAFT12kHz8BitMono',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SAFGetWaveFormatEx',
    'ISpeechRecoGrammar', 'DISPID_SMSALineId', 'SREAdaptation',
    'SpMemoryStream', 'SPEI_SENTENCE_BOUNDARY', 'DISPID_SPPName',
    'DISPID_SDKEnumKeys', 'SAFTADPCM_44kHzStereo',
    'ISpeechAudioFormat', 'SPWT_PRONUNCIATION',
    'DISPID_SOTGetAttribute', 'DISPID_SVAlertBoundary',
    'DISPID_SRCEInterference', 'DISPID_SpeechObjectTokenCategory',
    'SPEVENTSOURCEINFO', 'DISPID_SGRsCommitAndSave',
    'DISPID_SRCRetainedAudio', 'DISPID_SRRPhraseInfo', 'SVPOver',
    'SpeechCategoryAudioIn', 'DISPID_SRCBookmark',
    'ISpeechBaseStream', 'DISPID_SpeechAudioStatus', 'DISPID_SAFType',
    'ISpeechPhraseProperty', 'SPEI_RESERVED2', 'SAFTGSM610_44kHzMono',
    'ISpeechDataKey', 'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SVStatus',
    'SPEI_UNDEFINED', 'SECFDefault', 'SVP_12',
    'DISPID_SRSCurrentStreamNumber', 'ISpeechAudioStatus', 'SVP_2',
    'SPAS_CLOSED', 'SpeechVisemeType', 'ISpResourceManager',
    'SpeechCategoryAudioOut', 'ISpeechPhraseReplacements',
    'DISPID_SLAddPronunciationByPhoneIds', 'SAFT44kHz8BitMono',
    'SINoise', 'DISPID_SOTsCount', 'ISpeechRecoResult',
    'SVSFIsNotXML', 'SPAR_Medium', 'STCInprocServer', 'SPAR_High',
    'ISpEventSource', 'SDTAudio', 'SPBO_NONE', 'DISPID_SPRuleName',
    'DISPID_SPIRetainedSizeBytes', 'SpObjectTokenCategory',
    'SAFTDefault', '_SPAUDIOSTATE', 'SPRULESTATE', 'DISPID_SLPType',
    ...
    'ISpeechPhraseAlternates', 'SpLexicon', 'SVSFIsFilename',
    'DISPID_SpeechCustomStream', 'SpeechAllElements',
    'DISPID_SRSCurrentStreamPosition', 'SPINTERFERENCE',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SAEventHandle',
    'SPGRAMMARWORDTYPE', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SpeechRunState', 'SP_VISEME_14', 'DISPID_SRGetFormat',
    'SPAS_PAUSE', 'DISPID_SpeechAudioBufferInfo',
    'SPWORDPRONOUNCEABLE', 'ISpDataKey', 'SPSFunction',
    'DISPID_SPIAudioSizeBytes', 'SPSHT_Unknown',
    'SpeechGrammarTagDictation', 'SVP_14', 'DISPID_SVEBookmark',
    'DISPID_SPRulesItem', 'SpeechCategoryRecognizers', 'SPAR_Low',
    'SPAUDIOSTATUS', 'SPEI_TTS_PRIVATE', 'SGSExclusive',
    'SpeechDataKeyLocation', 'DISPID_SRGCmdLoadFromObject',
    'SGDSInactive', 'SpeechPropertyResponseSpeed',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPPS_Function',
    'DISPID_SVDisplayUI', 'SRARoot', 'DISPID_SVEViseme', 'SGDSActive',
    'SpeechEngineProperties', 'SPEI_MAX_TTS', 'SpeechGrammarState',
    'DISPID_SGRsCommit', 'SPPHRASEPROPERTY',
    'DISPID_SVESentenceBoundary', 'DISPID_SPERetainedStreamOffset',
    'SPFM_CREATE', 'ISpeechWaveFormatEx', 'SPSEMANTICFORMAT',
    'DISPID_SPIAudioSizeTime', 'SITooFast',
    'DISPID_SRCEPropertyStringChange', 'SPINTERFERENCE_NOISE',
    'SPSMF_UPS', 'SRADefaultToActive', 'SpeechTokenKeyFiles',
    'DISPID_SpeechPhraseReplacement', 'SAFT16kHz8BitMono', 'SPEVENT',
    'SRESoundEnd', 'ISpeechPhraseElement', 'ISpeechPhraseInfo',
    'SAFT32kHz16BitMono', 'DISPID_SGRSTRule', 'SPEI_VOICE_CHANGE',
    'IStream', 'SPPHRASEREPLACEMENT', 'SPFM_OPEN_READWRITE',
    'ISpeechRecoResult2',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SASetState', 'SRCS_Disabled',
    'DISPID_SPRNumberOfElements', 'ISpeechPhraseReplacement',
    'SPRS_ACTIVE', 'DISPID_SMSGetData', 'ISpeechPhraseElements',
    'DISPID_SBSWrite', 'SP_VISEME_6', 'SVSFParseMask',
    'DISPID_SPAStartElementInResult', 'SpeechRuleAttributes',
    'DISPID_SLPs_NewEnum', 'DISPID_SOTRemoveStorageFileName',
    'SP_VISEME_19', 'SPEI_INTERFERENCE', 'SPXMLRESULTOPTIONS',
    'SP_VISEME_3', 'DISPID_SVEStreamStart', 'DISPID_SVEPhoneme',
    'DISPID_SRGId', 'SPXRO_Alternates_SML',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SGRSTWeight',
    'SPTEXTSELECTIONINFO', 'DISPID_SRSNumberOfActiveRules',
    'ISpeechMemoryStream', 'SASRun', 'DISPID_SVSVisemeId',
    'DISPID_SRCEAudioLevel', 'ISpVoice',
    'DISPID_SRGCmdLoadFromResource', 'SPRECOSTATE',
    'DISPID_SLPSymbolic', 'DISPID_SRCState', 'SDTAll',
    'SVSFParseAutodetect', 'DISPID_SRGetPropertyString',
    'SDTLexicalForm', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SPEsCount', 'SAFTADPCM_11kHzMono',
    'SpeechRecoProfileProperties', 'SpeechDictationTopicSpelling',
    'DISPID_SOTSetId', 'SpFileStream', 'SVSFIsXML',
    'DISPID_SRCEHypothesis', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SGRSRule', 'DISPID_SGRSTPropertyValue',
    'SPPS_Interjection', 'SPEI_START_INPUT_STREAM', 'SRCS_Enabled',
    'SPPS_Unknown', 'SPGS_EXCLUSIVE', 'SPSHORTCUTPAIRLIST',
    'ISpRecognizer3', 'ISpeechGrammarRuleStateTransition',
    'SAFTTrueSpeech_8kHz1BitMono', 'SpShortcut', 'SPBO_TIME_UNITS',
    'DISPID_SOTGetDescription', 'DISPID_SDKEnumValues', 'SVF_None',
    'DISPID_SpeechPhraseProperty', 'ISpeechVoiceStatus',
    'SPCS_DISABLED', 'SPEI_RESERVED6', 'DISPID_SOTCSetId',
    'eWORDTYPE_DELETED', 'DISPID_SPEPronunciation',
    'SAFT44kHz16BitStereo', 'SPXRO_SML', 'SREHypothesis',
    ...
    'DISPID_SRStatus', 'SPSERIALIZEDRESULT', 'SPPS_RESERVED3',
    'DISPID_SGRClear', 'SAFTExtendedAudioFormat', 'SVP_1',
    'SDA_Consume_Leading_Spaces', 'DISPID_SDKGetStringValue',
    'DISPID_SBSSeek', 'SpObjectToken', 'DISPID_SAVolume',
    'DISPID_SRCEEndStream', 'SSTTWildcard', 'eLEXTYPE_RESERVED4',
    'DISPID_SRCRequestedUIType', 'DISPID_SPCIdToPhone', 'SBOPause',
    'SAFT16kHz16BitStereo', 'SVP_3', 'SPCT_SLEEP',
    'ISpeechPhraseProperties', 'SVP_18', 'SPEI_HYPOTHESIS',
    'DISPID_SABufferInfo', 'SpeechEngineConfidence',
    'DISPID_SpeechPhraseAlternates', 'SPINTERFERENCE_TOOFAST',
    'ISpeechLexicon', 'DISPID_SOTsItem', 'SPRECOGNIZERSTATUS',
    'SAFTCCITT_uLaw_11kHzStereo', 'eLEXTYPE_PRIVATE5', 'SPEVENTENUM',
    'ISpRecognizer', 'SVEAllEvents', 'DISPID_SWFEBitsPerSample',
    'SPEI_END_INPUT_STREAM', 'SPPS_RESERVED2',
    'DISPID_SPERetainedSizeBytes', 'SAFT8kHz8BitStereo',
    'SP_VISEME_8', 'SPEI_ADAPTATION', 'DISPID_SpeechRecoContext',
    'DISPID_SWFEBlockAlign', 'SRAORetainAudio',
    'DISPID_SDKDeleteValue', 'DISPID_SRGCmdLoadFromFile',
    'SAFT44kHz16BitMono', 'DISPID_SOTIsUISupported',
    'SpUnCompressedLexicon', 'SVP_9', 'ISpeechRecoResultDispatch',
    'SpStream', 'eLEXTYPE_PRIVATE3', 'DISPID_SPELexicalForm',
    'SREPrivate', 'SGRSTTRule', 'eLEXTYPE_PRIVATE11', 'IEnumString',
    'DISPID_SWFEExtraData', 'SAFT8kHz16BitMono', 'DISPID_SLWLangId',
    'SVSFDefault', '_ISpeechRecoContextEvents', 'SLOStatic',
    'SpeechGrammarTagWildcard', 'DISPID_SRCESoundEnd',
    'ISpeechPhraseRule', 'SPDKL_CurrentUser', 'eLEXTYPE_PRIVATE4',
    'SpeechStreamSeekPositionType',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SVSFPersistXML',
    'SP_VISEME_12', 'SP_VISEME_15', 'SPSNoun', 'SPLOADOPTIONS',
    ...
    'SPWF_SRENGINE', 'DISPID_SVGetVoices', 'SBONone',
    'eLEXTYPE_PRIVATE17', 'DISPID_SAStatus', 'SPSERIALIZEDPHRASE',
    'SRAInterpreter', 'SPRECOCONTEXTSTATUS', 'SFTInput',
    'SpeechAudioFormatGUIDWave', 'ISpeechAudioBufferInfo', 'SVP_16',
    ...
    'SPSTREAMFORMATTYPE', 'DISPID_SpeechPhraseBuilder',
    'SpeechVisemeFeature', 'SAFT48kHz8BitStereo',
    'DISPID_SPAPhraseInfo', 'DISPID_SRCERequestUI', 'SP_VISEME_5',
    ...
    'SPWORD', 'SP_VISEME_16', 'DISPID_SRGDictationLoad',
    'DISPID_SGRSTPropertyName', 'SVEWordBoundary', 'SPSInterjection',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'Speech_StreamPos_RealTime', 'DISPID_SLWType', 'SPAO_NONE',
    'SWPKnownWordPronounceable', 'eLEXTYPE_USER',
    'DISPID_SGRSAddWordTransition', 'DISPID_SVSpeakCompleteEvent',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SPEEngineConfidence',
    'SpNotifyTranslator', 'SPEI_FALSE_RECOGNITION',
    'SDTPronunciation', 'SpeechWordPronounceable', 'SRAONone',
    'DISPID_SPAsCount', 'ISpeechPhraseRules',
    'DISPIDSPTSI_ActiveLength', 'SpMMAudioEnum',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SRRSpeakAudio', 'SRSInactive',
    'DISPID_SpeechLexicon', 'SSFMCreateForWrite', 'SVEViseme',
    ...
    'DISPID_SRGCmdSetRuleState', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SPRules_NewEnum', 'DISPID_SPPValue',
    'DISPID_SVIsUISupported', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SpeechLexiconProns', 'SP_VISEME_0', 'SREAllEvents',
    'DISPID_SAFGuid', 'SpeechTokenContext', 'ISpeechPhraseAlternate',
    'SAFTADPCM_44kHzMono', 'ISpPhraseAlt', 'DISPID_SPPFirstElement',
    'SpeechAudioProperties', 'eLEXTYPE_PRIVATE16', 'SAFT8kHz8BitMono',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SRGState',
    'DISPID_SAFSetWaveFormatEx', 'SPCT_DICTATION',
    'DISPID_SVSLastBookmarkId', 'DISPID_SRCEStartStream',
    'DISPID_SRCSetAdaptationData', 'DISPIDSPTSI_SelectionLength',
    'SSSPTRelativeToStart', 'DISPID_SpeechPhraseProperties',
    'DISPID_SpeechGrammarRules', 'DISPID_SRDisplayUI',
    'SPCONTEXTSTATE', 'eLEXTYPE_RESERVED9', 'SRTSMLTimeout',
    'SVF_Emphasis', 'SPVPRIORITY', 'SVPAlert', 'SPRECORESULTTIMES',
    'ISpeechGrammarRuleState', 'Speech_Max_Pron_Length',
    'DISPID_SVSLastResult', 'SAFT22kHz8BitMono', 'SAFT48kHz16BitMono',
    'eLEXTYPE_PRIVATE20', 'SPSNotOverriden', 'SRTReSent',
    'DISPID_SRGCmdLoadFromMemory', 'STSF_CommonAppData',
    'SAFTADPCM_8kHzStereo', 'DISPID_SpeechVoiceEvent',
    'SPBINARYGRAMMAR', 'SPGS_DISABLED', 'SRERecognition',
    'SPRST_ACTIVE_ALWAYS', 'SVSFNLPMask', 'DISPIDSPRG', 'SGSEnabled',
    'IInternetSecurityManager', 'SPVISEMES',
    'DISPID_SpeechRecoResult', 'ISpeechMMSysAudio',
    'SAFT11kHz8BitStereo', 'SVP_19', 'SPWT_DISPLAY',
    'DISPID_SVSPhonemeId', 'DISPID_SPRuleId', 'SPSHT_NotOverriden',
    'DISPID_SWFEFormatTag', 'ISpNotifyTranslator',
    'eLEXTYPE_PRIVATE7', 'ISpStream', 'SAFTCCITT_uLaw_22kHzMono',
    'SPDATAKEYLOCATION', 'SP_VISEME_17', 'DISPID_SMSADeviceId',
    'DISPID_SGRId', 'STCLocalServer', 'SPEI_PROPERTY_STRING_CHANGE',
    'SpeechGrammarTagUnlimitedDictation', 'SPVPRI_ALERT',
    'DISPID_SRAudioInputStream', 'DISPID_SOTCategory',
    'ISpGrammarBuilder', 'SpAudioFormat', 'DISPID_SVAudioOutput',
    'SPINTERFERENCE_NONE', 'DISPID_SRRAudio',
    'SpeechCategoryPhoneConverters', 'DISPID_SRRAudioFormat',
    'SP_VISEME_9', 'SDKLCurrentUser', 'SPWORDLIST',
    'DISPID_SPIElements', 'ISpeechLexiconWord', 'SVSFParseSapi',
    'eLEXTYPE_RESERVED10', 'DISPID_SVSpeakStream',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    '__MIDL_IWinTypes_0009', 'DISPID_SGRSTPropertyId', 'UINT_PTR',
    'SPEI_RESERVED3', 'DISPID_SRRecognizer',
    'ISpStreamFormatConverter', 'SpeechDiscardType', 'WAVEFORMATEX',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SRAudioInput',
    'SVEPhoneme', 'DISPID_SGRInitialState', 'ISpeechRecoContext',
    'SPEI_SOUND_START', 'SPSEMANTICERRORINFO', 'SpPhoneConverter',
    'SPEI_MIN_TTS', 'SPDKL_LocalMachine', 'SAFTADPCM_8kHzMono',
    'SPAR_Unknown', 'SpMMAudioIn', 'SpeechUserTraining',
    'SDTDisplayText', 'eLEXTYPE_RESERVED8', 'DISPID_SRCCreateGrammar',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SLGetGenerationChange', 'eLEXTYPE_PRIVATE18', 'SPPS_LMA',
    'DISPID_SRCERecognitionForOtherContext', 'SVP_0',
    'DISPID_SVEAudioLevel', 'SVEBookmark', 'SPDKL_CurrentConfig',
    'DISPID_SGRsDynamic', 'eLEXTYPE_PRIVATE19', 'SRADynamic',
    'ISpeechAudio', 'SpeechRecoContextState', 'SAFTText',
    'STCInprocHandler', 'ISpEventSink', 'DISPID_SRRTLength',
    'SPLO_STATIC', 'eLEXTYPE_PRIVATE14', 'SFTSREngine',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SVSLastBookmark',
    'SPSModifier', 'SECLowConfidence', 'DISPID_SRSetPropertyNumber',
    'DISPID_SRCRecognizer', 'SpeechWordType', 'DISPID_SGRsCount',
    'SRSActiveAlways', 'DISPID_SRGCmdSetRuleIdState',
    'SECFIgnoreWidth', 'DISPID_SPPConfidence', 'DISPID_SLPsCount',
    'eLEXTYPE_PRIVATE2', 'DISPID_SWFEAvgBytesPerSec',
    'SPPS_RESERVED1', 'SVP_21', 'DISPID_SPISaveToMemory',
    'SpSharedRecognizer', 'tagSPTEXTSELECTIONINFO', 'SLTUser',
    'DISPID_SLGenerationId', 'SREFalseRecognition',
    'SDA_Two_Trailing_Spaces', 'SPEI_TTS_BOOKMARK', 'SREStateChange',
    'DISPID_SGRsFindRule', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SDKDeleteKey', 'SPSLMA', 'DISPID_SVEEnginePrivate',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SRIsUISupported',
    'DISPID_SGRSTType', 'eLEXTYPE_USER_SHORTCUT',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SPPParent',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SRSSupportedLanguages',
    'SREPropertyStringChange', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SLWsCount', 'SpeechPropertyResourceUsage',
    'DISPID_SDKOpenKey', 'SGRSTTWildcard', 'DISPID_SPCPhoneToId',
    'SAFTCCITT_ALaw_11kHzStereo', 'eLEXTYPE_PRIVATE8',
    'DISPID_SpeechPhraseElements', 'SASClosed',
    'DISPID_SpeechDataKey', 'SPAUDIOBUFFERINFO', 'SPCT_SUB_COMMAND',
    'SP_VISEME_20', 'DISPID_SpeechMemoryStream',
    'SDA_One_Trailing_Space', 'SpMMAudioOut', 'SVP_6',
    'SAFT48kHz16BitStereo', 'DISPID_SGRSAddRuleTransition',
    'ISpLexicon', 'DISPIDSPTSI_SelectionOffset',
    '_ISpeechVoiceEvents', 'DISPID_SLRemovePronunciation',
    'ISpSerializeState', 'SPEI_PHONEME', 'ISpObjectToken',
    'SAFTCCITT_uLaw_11kHzMono', 'SpeechLoadOption', 'SPSHT_OTHER',
    'DISPID_SpeechPhraseRule', 'SECFEmulateResult', 'SSFMOpenForRead',
    'DISPID_SPACommit', 'DISPID_SGRAddResource', 'SRESoundStart',
    'SVP_5', 'SAFTNoAssignedFormat', 'SP_VISEME_11',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SPEAudioSizeBytes',
    'SPPHRASEELEMENT', 'DISPID_SLPLangId', 'SAFTCCITT_ALaw_22kHzMono',
    'SAFTNonStandardFormat', 'SPVOICESTATUS',
    'SAFTCCITT_ALaw_8kHzMono', 'SVESentenceBoundary',
    'SAFT16kHz16BitMono', 'SPGS_ENABLED', 'DISPID_SpeechAudioFormat',
    'DISPID_SpeechAudio', 'DISPID_SRCEEnginePrivate',
    'DISPID_SRGetRecognizers', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SPERequiredConfidence', 'DISPID_SVPriority',
    'ISpeechPhoneConverter', 'SPPROPERTYINFO', 'DISPID_SPIProperties',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPLEXICONTYPE',
    'SPRST_ACTIVE', 'DISPID_SPPsCount', 'SVEPrivate', 'SLODynamic',
    'DISPID_SVEWord', 'DISPID_SDKGetBinaryValue', 'SPBOOKMARKOPTIONS',
    'DISPID_SPRuleNumberOfElements', 'SVP_13', 'SPPS_RESERVED4',
    'SPEI_RESERVED1', 'SpeechRuleState', 'DISPID_SABIBufferSize',
    'ISpMMSysAudio', 'ISequentialStream', 'SP_VISEME_18',
    'DISPID_SRCESoundStart', 'SRSActive', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SGRAttributes',
    'SPAUDIOSTATE', 'SGDisplay', 'SVP_10', 'DISPID_SRCPause',
    'SVSFParseSsml', 'SPEI_RESERVED5', 'SPPS_Noncontent',
    'DISPID_SRRDiscardResultInfo', 'ISpPhoneticAlphabetSelection',
    'DISPID_SRCVoice', 'ISpeechRecognizerStatus', 'SINoSignal',
    'DISPID_SOTCId', 'SpeechVoicePriority', 'SpeechVoiceEvents',
    'DISPID_SGRSTsCount', 'STSF_LocalAppData',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SpeechObjectTokens',
    'SP_VISEME_4', 'DISPID_SPRText', 'SpVoice', 'SAFT22kHz8BitStereo',
    'DISPID_SPIGetText', 'eLEXTYPE_PRIVATE13', 'SPEI_PHRASE_START',
    'DISPID_SVSkip', 'SpWaveFormatEx', 'SpCompressedLexicon',
    'ISpPhrase', 'IEnumSpObjectTokens', 'SP_VISEME_1',
    'SpeechCategoryVoices', 'SPEI_WORD_BOUNDARY',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SGRSTransitions',
    'SPPS_Noun', 'SDTReplacement', 'SAFTCCITT_uLaw_44kHzMono',
    'SpeechPropertyAdaptationOn', 'SVSFUnusedFlags',
    'DISPID_SGRAddState', 'DISPID_SVSRunningState',
    'DISPID_SGRSTsItem', 'SGSDisabled', 'SpeechLexiconType',
    'SDTProperty', 'DISPID_SWFEChannels', 'SGRSTTTextBuffer',
    'DISPID_SLPsItem', 'DISPID_SRRTTickCount', 'SPAS_RUN',
    'DISPID_SRIsShared', 'Speech_Max_Word_Length',
    'DISPID_SRGSetWordSequenceData', 'SPVPRI_NORMAL',
    'ISpRecoContext', 'SPINTERFERENCE_TOOQUIET', 'SPWAVEFORMATTYPE',
    'DISPID_SPRuleFirstElement', 'SPEI_SOUND_END', 'SPSHORTCUTPAIR',
    'DISPID_SpeechPhraseElement', 'ISpRecognizer2',
    'DISPID_SRGSetTextSelection', 'SVEVoiceChange', 'SREInterference',
    'SGRSTTDictation', 'SAFTCCITT_ALaw_44kHzMono',
    'SPEI_END_SR_STREAM', 'DISPID_SpeechBaseStream',
    'DISPID_SLGetWords', 'SPLO_DYNAMIC', 'SRERecoOtherContext',
    'DISPID_SRCResume', 'DISPID_SpeechVoice', 'SPPHRASERULE',
    'SAFTADPCM_11kHzStereo', 'ISpRecoContext2',
    'DISPID_SASNonBlockingIO', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SPDKL_DefaultLocation', 'DISPID_SRGRecoContext',
    'DISPID_SGRName', 'SPEI_RECOGNITION', 'SpeechAudioState',
    'DISPID_SPIGrammarId', 'SP_VISEME_2', 'SPSVerb',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SPRuleParent',
    'DISPID_SRGRules', 'DISPID_SASCurrentDevicePosition', 'SPRULE',
    'DISPID_SPARecoResult', 'DISPID_SLWsItem', 'eLEXTYPE_PRIVATE10',
    'DISPID_SLWs_NewEnum', 'SASStop', 'SVSFNLPSpeakPunc',
    'DISPID_SFSClose', 'DISPID_SWFESamplesPerSec',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SRCRetainedAudioFormat',
    'SLTApp', 'SpCustomStream', 'SWPUnknownWordPronounceable',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SPRuleEngineConfidence',
    'SPFM_NUM_MODES', 'DISPID_SRSClsidEngine', 'SAFTGSM610_8kHzMono',
    'SpNullPhoneConverter', '_RemotableHandle',
    'SpeechRetainedAudioOptions', 'SVP_15'
]

_check_version('1.2.0', 1697037468.449530)
